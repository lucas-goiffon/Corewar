...
void print_infos_ncurses(info_t *info, WINDOW **w)
{
    ...
    mvwprintw(w[1], 2, COLS / 2 - 68, WRITE_COREWAR_1);
    mvwprintw(w[1], 3, COLS / 2 - 68, WRITE_COREWAR_2);
    mvwprintw(w[1], 4, COLS / 2 - 68, WRITE_COREWAR_3);
    mvwprintw(w[1], 5, COLS / 2 - 68, WRITE_COREWAR_4);
    mvwprintw(w[1], 6, COLS / 2 - 68, WRITE_COREWAR_5);
    mvwprintw(w[1], 7, COLS / 2 - 68, WRITE_COREWAR_6);
    if (info->last_alive != NULL)
